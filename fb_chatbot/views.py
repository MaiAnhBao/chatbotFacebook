...
#	response_msg = json.dumps({"recipient":{"id":fbid},"message":{"text":response_msg.getMessage()})
	status = requests.post(post_message_url, headers = {"Content-Type": "application/json"},data=response_msg.getMessage())
	print(status.json())
